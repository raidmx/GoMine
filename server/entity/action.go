...
// EatGrassAction is a world.EatGrassAction that makes an entity eat grass
type EatGrassAction struct{ action }

// JumpAction ...
type JumpAction struct{ action }

// SwimAction ...
type SwimAction struct{ action }

// StartAttacking ...
type StartAttacking struct{ action }

// StopAttacking ...
type StopAttacking struct{ action }
