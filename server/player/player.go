...
import (
	...
	"github.com/EstralMC/GoMine/server/block/model"
	...
	"github.com/EstralMC/GoMine/server/internal/sliceutil"
	...
	"github.com/EstralMC/GoMine/server/player/bossbar"
	"github.com/EstralMC/GoMine/server/player/chat"
	"github.com/EstralMC/GoMine/server/player/form"
	"github.com/EstralMC/GoMine/server/player/scoreboard"
	"github.com/EstralMC/GoMine/server/player/skin"
	"github.com/EstralMC/GoMine/server/player/title"
	"github.com/EstralMC/GoMine/server/session"
...
func (p *Player) BreakBlock(pos cube.Pos) {
	...
	posAbove := cube.PosFromVec3(pos.Vec3().Add(mgl64.Vec3{0, 1, 0}))
	blkAbove := w.Block(posAbove)

	if (blkAbove.Model() == model.Empty{}) {
		p.BreakBlock(posAbove)
	}
