...
type Viewer interface {
	...
	// ViewEntityDeltaMovement views the movement of an entity. The entity is moved with a delta position, yaw and
	// pitch, which, when applied to the respective values of the entity, will result in the final values.
	ViewEntityDeltaMovement(e Entity, pos mgl64.Vec3, yaw, pitch float64, onGround bool)
...
func (NopViewer) ViewEntityDeltaMovement(Entity, mgl64.Vec3, float64, float64, bool) {}
